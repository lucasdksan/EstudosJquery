$(document).ready(function () {
    ...
    $(".containerEventJQUERY > button").mousemove(function (e) {
        $(".containerEventJQUERY > .containerResult").text(`X: ${e.clientX}  Y: ${e.clientY}`);
    });

    $(".formText :text").keyup(function (e) {
        $(".whiteBoard").text(`${$(this).val()}`);
    }).focus(function () {
